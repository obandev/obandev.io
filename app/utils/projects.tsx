...
export default [
  {
    wrapperClass: 'relative h-40 max-w-[160px] mb-4 bg-red-500',
    alt: 'quext',
    src: quext,
  ...
  {
    wrapperClass: 'relative h-80  max-w-[160px] mb-4 sm:mb-0  bg-red-500',
    alt: 'parsley health',
    src: ph,
  ...
  {
    wrapperClass: 'relative h-40  max-w-[160px] sm:h-80 sm:mb-4  bg-red-500',
    alt: 'delfino',
    src: delfino,
    size: '(max-width: 768px) 213px, 33vw',
    imgClass: 'rounded-lg object-cover',
  ...
  {
    wrapperClass: 'relative h-40  max-w-[160px] mb-4 sm:mb-0  bg-red-500',
    alt: 'nw',
    src: nw,
    size: '(max-width: 768px) 213px, 33vw',
    imgClass: 'rounded-lg object-cover',
  ...
  {
    wrapperClass: 'relative h-80  max-w-[160px]  bg-red-500',
    alt: 'blockmatic',
    src: blockmatic,
