...
export default [
  {
    wrapperClass: 'relative h-40 mb-4 bg-black w-[30%]',
    alt: 'quext',
    src: quext,
  ...
  {
    wrapperClass: 'relative h-80 mb-4 sm:mb-0  bg-black w-[30%]',
    alt: 'parsley health',
    src: ph,
  ...
  {
    wrapperClass: 'relative h-40 sm:h-80 mb-4  bg-black  w-[30%]',
    alt: 'delfino',
    src: delfino,
    size: '(max-width: 768px) 213px, 33vw',
  ...
  {
    wrapperClass: 'relative h-40 mb-4 sm:mb-0  bg-black  w-[30%]',
    alt: 'nw',
    src: nw,
    size: '(max-width: 768px) 213px, 33vw',
    imgClass: 'rounded-lg object-cover',
  ...
  {
    wrapperClass: 'relative h-80  bg-black w-[30%]',
    alt: 'blockmatic',
    src: blockmatic,
